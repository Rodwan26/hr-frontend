...
export const Card = ({ className, title, subtitle, footer, children, ...props }: CardProps) => {
    return (
        <div
            className={cn(
                'bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col',
                className
            )}
            {...props}
        >
